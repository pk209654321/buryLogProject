...
//        alterColumnTEST();
    ...
    public static void selectTest() {
        ...
        list.add(column02);
        list.add(column03);
        List<Map<String, Object>> select = agent.select("impala::impala_kudu.my_first_table",agent.client, list);
...
//        row01.add(c02);
    ...
    public static void insertSingleTEST() throws KuduException {
        ...
        KuduRow myrows01 = new KuduRow();
        myrows01.setRows(row01);
        agent.insert("impala::impala_kudu.my_first_table", agent.client, myrows01);
    }
}
